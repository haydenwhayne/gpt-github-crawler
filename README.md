...
- **Table of Contents Compatibility:** Output is compatible with the Table of Contents (ToC). It is recommended to generate your ToC using our custom GPT, [Knowledge Summarizer GPT](https://chat.openai.com/g/g-McHIHioC4-knowledge-summarizer). For more info on the ToC and our GPT visit the [Knowledge Summarizer GPT GitHub](https://github.com/phloai/knowledge-summarizer-gpt).
